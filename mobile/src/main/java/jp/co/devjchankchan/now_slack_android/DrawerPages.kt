...
import jp.co.devjchankchan.now_slack_android.fragments.AccountManagerFragment
...
enum class DrawerPages(val menuId: Int) {
    ACCOUNT_MANAGER(R.id.nav_account) {
        override fun createFragment(): Fragment = AccountManagerFragment.newInstance(1)
    },
